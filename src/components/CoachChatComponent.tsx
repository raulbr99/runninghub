                    ...
                    <div className="absolute bottom-full mb-2 left-0 w-64 max-h-80 overflow-y-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 z-20">
                      <div className="p-2">
                        <div className="flex items-center justify-between px-3 py-2">
                          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Modelos</p>
                          <a href="/settings" className="text-xs text-green-600 hover:underline">Editar</a>
                        </div>
